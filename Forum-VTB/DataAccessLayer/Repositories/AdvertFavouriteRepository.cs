...
{
    public class AdvertFavouriteRepository : Repository<AdvertFavourite>, IAdvertFavouriteRepository
    {
        public AdvertFavouriteRepository(ForumVTBDbContext context) : base(context)
        {

        }

        public async Task<AdvertFavourite> GetByAdvertAndUserIds(string advertId, string userId)
        {
